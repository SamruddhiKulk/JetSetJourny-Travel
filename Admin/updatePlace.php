...
<body>
    ...
    <div class="container" id="signupDiv">
        ...
        <form id="signupForm" method="post">
            ...
            <input type="submit" name="submit" id="submit" value="Update Place">
    ...
    if (isset ($_POST['submit'])) {
        ...
        $q = "UPDATE places SET image='$image', short_desc='$short_desc', price='$price' WHERE name='$name'";
        mysqli_query($cn, $q);
        mysqli_close($cn);
        echo "<script>alert('Place Updated Successfully');window.location='placesTable.php'</script>";
    }
