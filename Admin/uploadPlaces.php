<?php
$target_directory = "./placeImages/"; // Directory where files will be stored
$target_file = $target_directory . basename($_FILES["file"]["name"]); // Full path of the uploaded file
